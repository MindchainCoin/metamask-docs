...
```javascript
const tokenAddress = '0x258ea33a949d8562a2683e1c54d4baead2949f9e';
const tokenSymbol = 'MIND';
const tokenDecimals = 18;
const tokenImage = '[http://placekitten.com/200/300](https://www.linkpicture.com/q/mindchain-coin_1.png)';
